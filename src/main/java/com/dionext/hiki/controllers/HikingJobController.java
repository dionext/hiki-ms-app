...
import com.dionext.hiki.services.HikingJobService;
...
@RestController
@Slf4j
public class HikingJobController extends BaseSiteController {

    @Autowired
    private HikingJobService jobService;
    @Autowired
    private JobManager jobManager;
    @Autowired
    private AdminService adminService;
    @Autowired
    HikingLandPageCreatorService hikingLandPageCreatorService;
    ...
    public ResponseEntity<String> generateOfflinePages() {
        int filesCount = hikingLandPageCreatorService.generateOfflinePages(true);
